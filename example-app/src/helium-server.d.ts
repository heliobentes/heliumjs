...
import type { getProfile as method_1_type } from './server/profile';
import type { updateProfile as method_2_type } from './server/profile';
import type { getTasks as method_3_type } from './server/tasks/index';
import type { createTask as method_4_type } from './server/tasks/index';
import type { deleteTask as method_5_type } from './server/tasks/index';
import type { editTask as method_6_type } from './server/tasks/index';
